...
exports.setApp = function(app, client) {
  ...
  app.post('/api/flashcards/generate_from_note', async (req, res) => {
    ...
    try {
      ...
      const promptText = `I am going to provide information, create notecards that are relevant to the information with a question and answer. Create enough cards to sufficiently display all critical information, depending on the size of the information. The output you create needs to be in a strict json format of type { "flashcards": [ {"question": "<your question>", "answer": "<your answer>" } ] } . Output no extra characters besides the json. Output nothing besides the designated JSON. Do not include triple backticks, code fences, or ANY text outside the json. Here is the information: ${noteContent}`;
      ...
      // For live deployment-
      // const url = 'http://coolestappever.xyz/spi/flashcards/save_generated_cards';
